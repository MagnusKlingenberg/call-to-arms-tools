...
function NumberInput({ name, props }: { name: string; props: UseFormRegisterReturn }) {
  return (
    <>
...
function TextInput({ name, props }: { name: string; props: UseFormRegisterReturn }) {
  return (
    <>
      <div className="inputBox">
        <label>
...
function Building({
  ...
  buildingProps: UseFormRegisterReturn;
  checkboxProps: UseFormRegisterReturn;
  harvestEffectProps: UseFormRegisterReturn;
}) {
  return (
    <>
...
export default function SettlementRoster() {
  const [buildings, setBuildings] = usePersistedState<any>("Settlement", {});
